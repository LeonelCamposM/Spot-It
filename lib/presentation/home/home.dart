...
class _RoomPageState extends State<RoomPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Inicio'), backgroundColor: Color.fromARGB(255, 06, 70, 99)),
      body: Padding(
...
class _RoomWidgetState extends State<_RoomWidget> {
  ...
  final ButtonStyle style = getButtonStyle(650, 85, 30.0, Color.fromARGB(255, 06, 70, 99));
